...
public class DBManager implements IDBManager {
    @Override
    public List<Student> getAllActivesStudents() {
    ...
    public void modifyStudent(String id, String surname, String name, String group, String dateToDatabase) {
        try {
            ...
            Connection conn = DriverManager.getConnection(Constants.DB_URL_CONNECTION);
            Statement stmt = conn.createStatement();
            stmt.execute("UPDATE `student` SET `surname` = '" + surname + "', `name` = '" + name + "', `group` = '" + group + "', `date` = '" + dateToDatabase + "', `status` = '1' WHERE (`id` = '" + id + "');");
    ...
    @Override
    public List<Mark> getMarksByTerm(int idTerm, String idStud) {
        ArrayList<Mark> marks = new ArrayList<>();
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn = DriverManager.getConnection(Constants.DB_URL_CONNECTION);
            Statement stmt = conn.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT d.id, d.discipline, m.marks FROM mark as m\n" +
    ...
    @Override
    public List<Discipline> getAllActivesDiscipline() {
        ArrayList<Discipline> disciplines = new ArrayList<>();
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection connection = DriverManager.getConnection(Constants.DB_URL_CONNECTION);
    ...
    @Override
    public List<Term> getAllActivesTerms() {
    ...
    public void deleteTerm(String idTerm) {
        try {
            ...
            Connection conn = DriverManager.getConnection(Constants.DB_URL_CONNECTION);
            Statement stmt = conn.createStatement();
            stmt.execute("`term` SET `status` = '0' WHERE (`id` = '" + idTerm + "');");
